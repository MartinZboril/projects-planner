    ...
    public function dataTable($query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->editColumn('buttons', function (Client $client) {
                ...
                $buttons .= view('clients.partials.buttons', ['buttonSize' => 'xs', 'hideButtonText' => '', 'client' => $client, 'type' => 'table', 'tableIdentifier' => '#'.($this->table_identifier ?? 'clients-table'), 'redirect' => null]);
