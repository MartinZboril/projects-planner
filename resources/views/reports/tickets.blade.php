            ...
            <div class="container-fluid">
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                @include('reports.partials.card', ['title' => 'Total', 'value' => $data->get('total_tickets_count'), 'colour' => 'text-body'])
                                @include('reports.partials.card', ['title' => 'Active', 'value' => $data->get('active_tickets_count'), 'colour' => 'text-danger'])
                                @include('reports.partials.card', ['title' => 'Done', 'value' => $data->get('done_tickets_count'), 'colour' => 'text-success'])
                                @include('reports.partials.card', ['title' => 'Overdue', 'value' => $data->get('overdue_tickets_count'), 'colour' => 'text-danger'])
                            </div>
                            <div class="col-md-8">
                                <div class="card">
                        ...
                        <!-- Quarterly reports  -->
                        <div class="row">
                            @foreach ($data['quarterly_created_tickets'] as $value)
