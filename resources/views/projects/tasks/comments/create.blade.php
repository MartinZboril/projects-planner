<div>
    ...
    <div class="timeline-item">
        ...
        <div class="timeline-body">
            <form action="{{ route('projects.tasks.comments.store', ['project' => $project, 'task' => $task]) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('POST')
                @include('projects.tasks.comments.forms.fields', ['comment' => $comment, 'type' => 'create'])
            </form>
        </div>
    </div>
</div>
