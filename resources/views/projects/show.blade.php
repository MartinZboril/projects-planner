                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <x-chart.progress-bar headline="Time Plan" :title="$project->total_time . ' h'" :subtitle="'Est. Hours: ' . $project->estimated_hours . ' Hours'" chart-id="plan-progress-bar" :value="$project->time_plan >= 100 ? '1.0' : ($project->time_plan / 100)" :text="$project->time_plan . '%'" :colour="'#' . ($project->time_plan > 100 ? 'dc3545' : '28a745')" />
                            </div>
                            <div class="col-md-4">
