    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <!-- Form -->
                <form action="{{ route('projects.timers.update', ['project' => $project, 'timer' => $timer]) }}" method="post">
                    @csrf
                    @method('PATCH')
                    <x-timer.fields :$timer :close-route="route('projects.timers.index', $project)" type="edit" /> 
                </form>     
            </div>
        </section>
    </div>
