<div class="row">
    ...
    <div class="col-md-5">
        ...
        <div class="card">
            <div class="card-body">
                <input type="submit" name="save" class="btn btn-sm btn-primary mr-1" value="Save"><input type="submit" name="save_and_close" class="btn btn-sm btn-secondary" value="Save and close"> or <a href="{{ $type == 'edit' ? route('projects.milestones.show', ['project' => $project->id, 'milestone' => $milestone->id]) : route('projects.milestones.index', ['project' => $project->id]) }}" class="cancel-btn">Close</a></span>
            </div>
        </div>
    </div>
</div>