<div class="table-responsive">
    <table id="@if($milestones->count() > 0){{ $id }}@endif" class="table table-bordered table-striped">
        <thead>
            <tr>
                <th>Name</th>
        ...
        <tbody>
            @forelse ($milestones as $milestone)
                <tr>                                        
                    <td><a href="{{ route('projects.milestones.show', ['project' => $milestone->project->id, 'milestone' => $milestone->id]) }}">{{ $milestone->name }}</a></td>                                        
                    ...
                    <td>
                        ...
                        <a href="{{ route('projects.milestones.show', ['project' => $milestone->project->id, 'milestone' => $milestone->id]) }}" class="btn btn-xs btn-info"><i class="fas fa-eye"></i></a>
                    </td>
                </tr>
            @empty
                <tr>
