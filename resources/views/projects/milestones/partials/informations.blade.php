<div class="card card-primary card-outline">
    ...
    <div class="card-body">
        ...
        <span class="d-block">Owner: <b>@if ($milestone->owner->trashed()){{ $milestone->owner->full_name.' (deleted)' }}@else<a href="{{ route('users.show', $milestone->owner) }}">{{ $milestone->owner->full_name }}</a>@endif</b></span>
