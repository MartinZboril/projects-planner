<div>
    ...
    <div class="timeline-item">
        ...
        <div class="timeline-body">
            <form action="{{ route('projects.tickets.comments.store', ['project' => $project, 'ticket' => $ticket]) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('POST')
                @include('projects.tickets.comments.forms.fields', ['comment' => $comment, 'type' => 'create'])
            </form>
        </div>
    </div>
</div>
