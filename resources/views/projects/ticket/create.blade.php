                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="card rounded-0">
                            <div class="card-body">
                                <input type="submit" name="project_create" class="btn btn-sm btn-primary mr-1" value="Create"><input type="submit" name="project_create_and_close" class="btn btn-sm btn-secondary" value="Create and close"> or <a href="{{ route('projects.tickets', $project->id) }}" class="cancel-btn">Close</a></span>
                            </div>
                        </div>
                    </div>
                </div>  
