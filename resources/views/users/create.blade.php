                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="card rounded-0">
                            <div class="card-body">
                                <input type="submit" name="create" class="btn btn-sm btn-primary mr-2" value="Create"><input type="submit" name="create_and_close" class="btn btn-sm btn-secondary mr-2" value="Create and close"> or <a href="{{ route('users.index') }}" class="cancel-btn">Close</a></span>
                            </div>
                        </div>
                    </div>
                </div>    
