<div>
    ...
    <div class="timeline-item">
        ...
        <div class="timeline-body">
            <form action="{{ route('clients.comments.store', $client) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('POST')
                @include('clients.comments.forms.fields', ['comment' => $comment, 'type' => 'create'])
            </form>
        </div>
    </div>
</div>
