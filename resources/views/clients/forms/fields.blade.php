<div class="row">
    <div class="col-md-7">
        <div class="card card-primary card-outline">
            <div class="card-header">{{ $type == 'create' ? 'Create' : 'Edit' }} client</div>
            <div class="card-body">
    ...
    <div class="col-md-5">
        ...
        <div class="card">
            <div class="card-body">
                <input type="submit" name="save" class="btn btn-sm btn-primary mr-1" value="Save"><input type="submit" name="save_and_close" class="btn btn-sm btn-secondary" value="Save and close"> or <a href="{{ $type == 'edit' ? route('clients.detail', $client->id) : route('clients.index') }}" class="cancel-btn">Close</a></span>
            </div>
        </div>
    </div>
</div>  