    ...
    <div class="card-body">
        @forelse ($tasks as $task)
            <div class="card card-{{ $colour }} card-outline">
                ...
                <div class="card-body">
                    <span class="d-block">Due date: <span class="btn btn-sm btn-outline-{{ $task->overdue ? 'danger' : 'secondary' }} disabled mb-1" style="font-size:14px;">{{ $task->due_at->format('d.m.Y') }}</span></span>
